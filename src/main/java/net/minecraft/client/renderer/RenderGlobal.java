...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener {
    ...
    public static void drawOutlinedBoundingBox(AxisAlignedBB boundingBox, int red, int green, int blue, int alpha, float hitBoxSize) {
        Tessellator tessellator = Tessellator.getInstance();
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();

        float minX = (float) (boundingBox.minX - hitBoxSize);
        float minY = (float) (boundingBox.minY - hitBoxSize);
        float minZ = (float) (boundingBox.minZ - hitBoxSize);
        float maxX = (float) (boundingBox.maxX + hitBoxSize);
        float maxY = (float) (boundingBox.maxY + hitBoxSize);
        float maxZ = (float) (boundingBox.maxZ + hitBoxSize);
