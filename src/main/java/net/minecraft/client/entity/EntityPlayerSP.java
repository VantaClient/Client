...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public void onUpdateWalkingPlayer() {
        ...
        motionEvent.state = EventState.POST;
        motionEvent.call();
    }
    ...
    public Vec3 getLook(float partialTicks) {
        RotationLookEvent rotationLookEvent = new RotationLookEvent(this.getVectorForRotation(this.rotationPitch, this.rotationYaw), partialTicks);
        rotationLookEvent.call();
